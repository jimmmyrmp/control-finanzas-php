...
<head>
  ...
  <title>Ver Salidas — Control de Finanzas</title>
...
<main class="main">
  ...
  <div class="tabla-card">
    <div class="tabla-header">
      ...
      <div class="total-badge s">Total: $<?= number_format($total, 2) ?></div>
    </div>

    <?php if (empty($lista)): ?>
      <div class="vacio">No hay salidas registradas aún.</div>
    <?php else: ?>
